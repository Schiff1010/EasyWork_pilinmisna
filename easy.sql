...
CREATE TABLE `akun` (
  ...
  `level` enum('Job Seeker','Company') COLLATE utf8_unicode_ci NOT NULL
...
(1, 'zero', '123', 'Job Seeker'),
(2, 'one', '123', 'Company'),
(3, 'nono', 'nono12345', 'Job Seeker'),
(4, 'bleach', '123456789', 'Company');
...
CREATE TABLE `berkas` (
  ...
  `foto` blob NOT NULL,
  `nama_sertifikasi` varchar(100) COLLATE utf8_unicode_ci NOT NULL,
  `file_sertifikasi` blob NOT NULL,
  `doc_tambahan` blob NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci ROW_FORMAT=COMPACT;
...
INSERT INTO `company` (`id`, `id_akun`, `province_id`, `Nama_Perusahaan`, `Jenis_Perusahaan`, `Nama_Pegawai`, `jabatan`, `Email`, `situs`, `Alamat`, `No_Telp`) VALUES
(2220, 2, '13', 'PT AUSTINDO NUSANTARA JAYA', 'PERDAGANGAN', 'JERRY WIJAYA', 'marketing', 'wijaya10@gmail.com', '', 'Jl. Nusa Permai no. 7', '441-25-001'),
(2221, 4, '15', 'PT BUKIT ULUWATU', 'RESTORAN', 'DINDA DEWI', 'MANAGER', 'DEWI@gmail.com', '', 'Jl. Kesejahteraan III NO. 8', '440-51-023');
...
CREATE TABLE `jobseeker` (
  ...
  `jenis_kelamin` enum('Perempuan','Laki-Laki') COLLATE utf8_unicode_ci NOT NULL,
  `status` enum('Menikah','Belum Menikah') COLLATE utf8_unicode_ci NOT NULL,
  `no_hp` varchar(100) COLLATE utf8_unicode_ci NOT NULL,
  `email` varchar(100) COLLATE utf8_unicode_ci NOT NULL,
  `alamat` varchar(100) COLLATE utf8_unicode_ci NOT NULL,
  `pendidikan_terakhir` varchar(100) COLLATE utf8_unicode_ci NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci ROW_FORMAT=COMPACT;
...
INSERT INTO `jobseeker` (`id`, `id_akun`, `province_id`, `nama_lengkap`, `tahun_lahir`, `jenis_kelamin`, `status`, `no_hp`, `email`, `alamat`, `pendidikan_terakhir`) VALUES
(90901, 1, '13', 'Michael Putra', 1980, 'Laki-Laki', 'Menikah', '082355678340', 'putramichael@gmail.com', 'Jl. Pondok Indah Blok AA no. 10', 'S1'),
(90902, 3, '15', 'Sri Hartati', 1990, 'Perempuan', 'Belum Menikah', '081233564091', 'tatisri@yahoo.co.id', 'Jl. Pahlawan A no. 11', 'SMA');
...
CREATE TABLE `lowongan` (
  ...
  `detail_pekerjaan` text COLLATE utf8_unicode_ci NOT NULL,
  `syarat_syarat` text COLLATE utf8_unicode_ci NOT NULL,
...
--
-- Table structure for table `ngirim`
--
...
--
ALTER TABLE `berkas`
  ADD CONSTRAINT `berkas_ibfk_1` FOREIGN KEY (`idjs`) REFERENCES `jobseeker` (`id`);

--
-- Constraints for table `company`
--
ALTER TABLE `company`
  ADD CONSTRAINT `company_ibfk_1` FOREIGN KEY (`province_id`) REFERENCES `provinsi` (`id`) ON DELETE CASCADE ON UPDATE CASCADE,
  ADD CONSTRAINT `company_ibfk_2` FOREIGN KEY (`id_akun`) REFERENCES `akun` (`id`) ON DELETE NO ACTION ON UPDATE CASCADE;

--
-- Constraints for table `jobseeker`
--
ALTER TABLE `jobseeker`
  ADD CONSTRAINT `jobseeker_ibfk_1` FOREIGN KEY (`province_id`) REFERENCES `provinsi` (`id`) ON DELETE CASCADE ON UPDATE CASCADE,
  ADD CONSTRAINT `jobseeker_ibfk_2` FOREIGN KEY (`id_akun`) REFERENCES `akun` (`id`) ON DELETE NO ACTION ON UPDATE CASCADE;
...
--
ALTER TABLE `lowongan`
  ADD CONSTRAINT `lowongan_ibfk_1` FOREIGN KEY (`idemp`) REFERENCES `company` (`id`),
  ADD CONSTRAINT `lowongan_ibfk_2` FOREIGN KEY (`province_id`) REFERENCES `provinsi` (`id`) ON DELETE CASCADE ON UPDATE CASCADE;

--
-- Constraints for table `ngirim`
--
ALTER TABLE `ngirim`
  ADD CONSTRAINT `ngirim_ibfk_1` FOREIGN KEY (`idjs`) REFERENCES `jobseeker` (`id`),
  ADD CONSTRAINT `ngirim_ibfk_2` FOREIGN KEY (`idemp`) REFERENCES `company` (`id`);

--
-- Constraints for table `pengalaman_kerja`
--
ALTER TABLE `pengalaman_kerja`
  ADD CONSTRAINT `pengalaman_kerja_ibfk_1` FOREIGN KEY (`idjs`) REFERENCES `jobseeker` (`id`);
