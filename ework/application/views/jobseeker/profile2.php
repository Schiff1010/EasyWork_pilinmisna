        ...
        <div class="overlay">
            <div class="container">
                    ...
                    <div class="col-lg-2 col-md-2 col-sm-2 text-center">
                        ...
                        <a href="<?php echo base_url('') ?>search" class="wow bounceIn animated" data-wow-duration="1s" data-wow-delay=".7s">
                      ...
                      <div class="col-lg-10  col-md-10  col-sm-10 collapse active" id="dp">
